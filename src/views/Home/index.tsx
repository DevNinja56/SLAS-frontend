      ...
      <div className="w-10/12 mx-auto">
        ...
        <div className="flex w-full gap-7 mb-12">
          ...
          <div className="flex flex-col gap-6">
            <div className="drop-shadow-2xl p-6 bg-white w-4/5 mx-auto rounded-lg hover:border-l-8 hover:border-GreenBgColor hover:scale-x-110 transition duration-300 ease-in-out">
