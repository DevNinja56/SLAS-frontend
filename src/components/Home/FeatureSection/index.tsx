      ...
      <div className="w-10/12 mx-auto">
        ...
        <div className="flex gap-6">
            <div className="drop-shadow-2xl p-6 bg-white rounded-md ">
              <span className="font-bold flex items-center"> <AiOutlineGlobal className="inline mr-2"/>Global Transactions</span>
              <p>Seamlessly conduct cross-border payments, connecting you to a world of financial possibilities.</p>
            </div>
            <div className="drop-shadow-2xl p-6 bg-white rounded-md">
              <span className="font-bold flex items-center"><GrCurrency className="inline mr-2"/>Stellar Performance</span>
              <p>Experience swift and efficient financial transactions that redefine the speed of payments.  </p>
            </div>
            <div className="drop-shadow-2xl p-6 bg-white rounded-md">
              <span className="font-bold flex items-center"><MdOutlineSecurity className="inline mr-2"/>Ironclad Security</span>
