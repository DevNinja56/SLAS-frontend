    ...
    <div className="w-full my-12">
      <div className="w-10/12 mx-auto flex">
        <div className="flex flex-col gap-4 pt-8">
          <span className="text-4xl leading-headingLineHeight w-9/12 font-bold">
            Explore our current job openings and start your journey
          </span>
          <p className="w-9/12 text-sm font-medium leading-8">
        ...
        <img src="assets/images/Home/explore.PNG" className="w-10/12" alt="Banner" />
      </div>
    </div>
  )
}
