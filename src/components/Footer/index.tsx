...
const Footer = () => {
  ...
  return (
    <div className="w-full bg-FooterBgColor mt-40">
      <div className="w-10/12 mx-auto bg-GreenBgColor rounded-3xl py-6 px-6 flex flex-col gap-6 -translate-y-28">
        <span className="text-white font-semibold text-2xl mx-auto">Subscribe to our newsletter</span>
        ...
        <form onSubmit={handleSubmit} className="relative w-full">
          ...
          <button
            className="py-[11px] px-[39px] absolute right-24 bottom-2 top-2 bg-OrangeTextColor text-white text-sm hover:bg-opacity-50"
            type="submit"
          >
            SUBSCRIBE NOW
          </button>
